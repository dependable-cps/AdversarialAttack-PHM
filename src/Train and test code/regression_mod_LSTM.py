...
test_df = pd.read_csv('../../Dataset/myDataEach.txt', sep=" ", header=None)
...
truth_df = pd.read_csv('../../Dataset/myDataTrueEach.txt', sep=" ", header=None)
...
if os.path.isfile(model_path):
    ...
    filepath1 = '../../Output/PdM_LSTM_level.csv'
