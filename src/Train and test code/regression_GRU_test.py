...
model_path = '../../Output/GRU_Adv_train_model.h5'
...
test_df = pd.read_csv('../../Dataset/Cleaned_data.txt', sep=" ", header=None)
...
truth_df = pd.read_csv('../../Dataset/Cleaned_data_truth.txt', sep=" ", header=None)
...
if os.path.isfile(model_path):
    ...
    df1 = pd.DataFrame(seq_array_test_last[0])
    ...
    filepath1 = '../../Output/PdM_GRU_level.csv'

    df1.to_json(r'../../Output/PdM_GRU_level.json')

    with open('../../Output/PdM_GRU_level.json') as f:
        data = json.load(f)
    ...
    file_path='../../Output/PdM_GRU.json'


    b = seq_array_test_last[0]  # nested lists with same data, indices
    ...
    with open('../../Output/PdM_GRU.json') as f:
        data = json.load(f)
    b_new = json.loads(obj_text)
    a_new = np.array(data)
