...
model_path = '../../Output/CNN_regression_model_new.h5'
...
history = cnn.fit(seq_array, label_array, epochs=100, batch_size=230, validation_split=0.05, verbose=2,
...
if os.path.isfile(model_path):
    ...
    plt.show()
    fig_verify.savefig("../../Output/CNN_regression_model_new.png")
